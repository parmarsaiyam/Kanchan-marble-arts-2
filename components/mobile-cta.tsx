...
export function MobileCTA() {
  ...
  return (
    <>
      ...
      {/* Right FAB: WhatsApp (solid, no transparency) */}
      <div
  className={`fixed bottom-4 right-4 z-40 md:hidden transition-all duration-500 transform ${showButtons ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>
