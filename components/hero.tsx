      ...
      <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <Button
            asChild
            size="lg"
            className="bg-accent text-accent-foreground font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:text-black"
          >
            <a
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-accent text-accent hover:bg-accent hover:text-black bg-transparent shadow-lg hover:shadow-xl transition-all duration-300"
          >
            <a
